...
public class TileEntityRedstoneJukebox extends TileEntity implements IInventory, SimpleComponent {
    ...
    public int[]		playOrder				= new int[maxAmount];
	...
	public enum ComputerMethod {
		...
		getLoop,						// No arguments
		getPlayList,					// No arguments
		getPlayMode,					// No arguments
		playNextRecord,					// No arguments
		playRecord,						// Required Arg: jukebox slot index
		setActive,						// Required Arg: true/false
		setLoop,						// Required Arg: true/false
		setPlayMode,					// Required Arg: true/false
	...
	/*	if(method < 0 || method >= numMethods) {
		...
		*/
		...
		case setLoop:
			...
			newState = (Boolean)arguments[0];
			this.isLoop = newState;
			PacketHelper.sendJukeboxGUIPacket(this.isLoop, this.playMode);
			updateEntity();
			resync();
			return new Object[] {this.isLoop};
		...
		case getPlayMode:
			return new Object[] { playMode };
		
		case getLoop:
			return new Object[] { isLoop };
    ...
    public boolean playRecord(Integer sel) {
        ...
        if (this.playOrder[opt] != -1) {

        	// check the slot for a record. If don't find, advance on the play list
            ItemStack s = this.getStackInSlot(this.playOrder[opt]);
            if (s != null && Item.itemsList[s.itemID] instanceof ItemRecord) {
                ...
                this.currentPlaySlot = opt;
                this.currentJukeboxPlaySlot = this.playOrder[opt];
        ...
        while (this.nextPlaySlot > -1) {
            ...
            if (this.playOrder[checkedSlot] != -1) {
                ...
                if (s != null && Item.itemsList[s.itemID] instanceof ItemRecord) {
                    ...
                    System.out.println("Checked Slot Value: " + checkedSlot + "     Play Order length:" + this.songPlayList.length + "   currentPlaySlot:  " + this.currentPlaySlot + "   currentJukeboxPlaySlot:  " + this.currentJukeboxPlaySlot + "   recordID:  " + recordID);
    ...
    // -- Play the next record.
    public void playPreviousRecord() {
    ...
    @Callback
    public Object[] getActive(Context context, Arguments args) throws Throwable {
    	final Object[] arguments = new Object[args.count()];
        return callMethod("getActive", arguments);
    }
    ...
    @Callback
    public Object[] getLoop(Context context, Arguments args) throws Throwable {
    	final Object[] arguments = new Object[args.count()];
        return callMethod("getLoop", arguments);
    }
    ...
    @Callback
    public Object[] getPlayMode(Context context, Arguments args) throws Throwable {
    	final Object[] arguments = new Object[args.count()];
        return callMethod("getPlayMode", arguments);
    }
    ...
    @Callback
    public Object[] setLoop(Context context, Arguments args) throws Throwable {
    	final Object[] arguments = new Object[args.count()];
		for (int i = 0; i < args.count(); ++i) {
			arguments[i] = args.checkBoolean(i);
		}
        return callMethod("setLoop", arguments);
    }

    @Callback
    public Object[] setPlayMode(Context context, Arguments args) throws Throwable {
    	final Object[] arguments = new Object[args.count()];
		for (int i = 0; i < args.count(); ++i) {
			arguments[i] = args.checkInteger(i);
		}
        return callMethod("setPlayMode", arguments);
    }
