...
import redstonejukebox.config.ModInfo;
...
@NetworkMod(clientSideRequired = true, serverSideRequired = false, channels = { ModInfo.Channel }, packetHandler = redstonejukebox.network.PacketHandler.class)
public class ModRedstoneJukebox {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        // Textures and Icons paths
        ModRedstoneJukebox.blankRecordIcon = ModInfo.ResourcesNamespace + ":blank_record";
        ModRedstoneJukebox.customRecordIconArray = ModInfo.ResourcesNamespace + ":custom_record_";
        ModRedstoneJukebox.jukeboxDiscIcon = ModInfo.ResourcesNamespace + ":redstone_jukebox_disc";
        ModRedstoneJukebox.jukeboxTopIcon = ModInfo.ResourcesNamespace + ":redstone_jukebox_top";
        ModRedstoneJukebox.jukeboxBottomIcon = ModInfo.ResourcesNamespace + ":redstone_jukebox_bottom";
        ModRedstoneJukebox.jukeboxSideOnIcon = ModInfo.ResourcesNamespace + ":redstone_jukebox_on";
        ModRedstoneJukebox.jukeboxSideOffIcon = ModInfo.ResourcesNamespace + ":redstone_jukebox_off";
        ...
        ModRedstoneJukebox.redstoneJukeboxGui = new ResourceLocation(ModInfo.ResourcesNamespace, ModRedstoneJukebox.guiTextureJukebox);
        ModRedstoneJukebox.recordTradeGui = new ResourceLocation(ModInfo.ResourcesNamespace, ModRedstoneJukebox.guiTextureTrade);
